...
extension Item {
    ...
    static func load(json: JSON) -> Item {
        return Item(itemUrl: "", itemId: json["item_id"].int!, itemName: json["item_name"].string!, itemDesc: json["item_desc"].string!, itemPrice: json["item_price"].string!, buyHistories: [])
    }
}
